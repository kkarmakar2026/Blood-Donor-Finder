...
//        FROM users 
//        WHERE ($1::text IS NULL OR blood_group ILIKE $1) 
//          AND ($2::text IS NULL OR country ILIKE $2)
//          AND ($3::text IS NULL OR state ILIKE $3)
//          AND ($4::text IS NULL OR district ILIKE $4)
...
// ===========================
// Report Donor (NEW ROUTE)
// ===========================
router.post("/report-donor", async (req, res) => {
  const { donor_id, reason, description } = req.body;
