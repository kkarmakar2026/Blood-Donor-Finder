...
const Register = () => {
  ...
  return (
    ...
    <div className="max-w-sm mx-auto p-4 border rounded-lg shadow bg-white">
      <h1 className="text-xl font-bold mb-3 text-center">Register</h1>

      {/* Messages */}
      {error && <p className="text-red-600 text-center mb-2 text-sm">{error}</p>}
      {message && <p className="text-green-600 text-center mb-2 text-sm">{message}</p>}
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 text-sm">
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={handleChange}
          />
          I authorise this website to display my name and phone/WhatsApp for emergencies
        </label>
        ...
        <button
          ...
          } text-white py-2 rounded text-sm transition`}
        >
          Register
        </button>
      </form>
